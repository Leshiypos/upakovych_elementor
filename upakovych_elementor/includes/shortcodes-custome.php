	...
	<div class="header_mobile">
		<div class="wrap">
			...
			<ul class="always_display_mobile_icons">
				...
				<li><a class="request_call" href="#request_call"><span class="elementor-screen-only">Icon-phone-call</span><svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512">
		...
		<div class="mobile_menu_list not_active">
			<div class="wrap_list">
				...
				<ul class="contacts">
					...
					<li>
						<a href="https://yandex.ru/maps/2/saint-petersburg/house/polevaya_sabirovskaya_ulitsa_45k1/Z0kYdABlSUwDQFtjfXV4dXRlbA==/?ll=30.275141%2C59.994417&amp;z=18.4">
							<svg aria-hidden="true" class="point" viewBox="0 0 384 512" xmlns="http://www.w3.org/2000/svg">
				...
				<ul class="mobile_icons">
					<li><a class="" href="http://t.me/upakovych" target="_blank"><span class="elementor-screen-only">Telegram</span><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve" width="512" height="512">
								<g id="Artboard">
					...
					<li><a class="" href="https://wa.me/79921854801" target="_blank"><span class="elementor-screen-only">Whatsapp</span><svg class="e-font-icon-svg e-fab-whatsapp" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
					...
					<li><a class="" href="mailto:7795@upakovych.ru" target="_blank"><span class="elementor-screen-only">Icon-email</span><svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
...
?>
	<div class="mobile_cotalog_menu">
		<div class="burger_menu" id="burger_catalog_button">
			...
			<div class="text">Раскрыть каталог</div>
		</div>
