							...
							<div class="card <?php if ($key % 2) {
								...
								<div class="content">
									<div class="question">
										...
										<img src="<?php echo get_template_directory_uri(); ?>/assets/images/sections/icon/<?php if ($key % 2) {
																																echo "qw_left";
																															} else {
																																echo "qw_right";
																															} ?>.svg" alt="" />
	...
	function general_customer_reviews_section_func()
	{
		...
		?>
			<section class="general_customer_reviews_section">
              ...
              "
							src="https://yandex.ru/maps-reviews-widget/73654501305?comments"></iframe><a
							style="
                box-sizing: border-box;
              ...
              "
							...
							target="_blank"
							rel="noopener">Упаковыч на карте Санкт‑Петербурга — Яндекс Карты</a>
					</div>
				</div>
			</section>
		<?php
						...
						<div class="col">
							...
							<div class="info">
								...
								<a
									...
									target="_blank"
									rel="noopener">Санкт-Петербург <br />
